...
module.exports = (app, nextMain) => {
   ...
   */
  app.get('/products', requireAuth, products.read);
   ...
   */
  app.get('/products/:productId', requireAuth, products.readById);
   ...
   * @code {404} si el producto con `productId` indicado no existe
   */
  app.post('/products', requireAdmin, products.create);
   ...
   * @code {404} si el producto con `productId` indicado no existe
   */
  app.put('/products/:productId', requireAdmin, products.updateProduct);
   ...
   * @code {404} si el producto con `productId` indicado no existe
   */
  app.delete('/products/:productId', requireAdmin, products.delete);
